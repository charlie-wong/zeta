...
#   Fixed 半宽破折号
#
# Unhinted 无微调字形版本，即使用 Iosevka 和 Source Han Sans 原版字形
...
# 字重(字体粗细)
#   Extralight  特细    Extralight Italic 特细斜体
#   Light       较细    Light Italic      较细斜体
#   Regular     标准    Italic            标准斜体
#   Semibold    半粗    Semibold Italic   半粗斜体
